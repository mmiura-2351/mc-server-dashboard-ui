...
export function ConnectionWarningBanner({
  ...
  const { state, checkConnection, isDown, isDegraded, isChecking } =
    useConnection();
  ...
  const shouldShowBanner =
    !dismissed && (isDown || (showOnDegraded && isDegraded));
  ...
  return (
    <div className={containerClasses} role="alert" aria-live="polite">
      <div className={styles.content}>
        <div className={styles.icon}>{isDown ? "❌" : "⚠️"}</div>
        ...
        <div className={styles.actions}>
          ...
          {showDetails && (
            <button
              ...
              aria-label={
                showDetailedInfo
                  ? t("connection.banner.hideDetails")
                  : t("connection.banner.details")
              }
            >
              {showDetailedInfo
                ? t("connection.banner.hideDetails")
